...
export const skills = [
  {
    ...
    text: "HTML 5",
    level: "⚫⚫⚫",
    image: <Image src={html} alt="html" width="64" height="64" />,
  },
  {
    id: nanoid(),
    text: "CSS 3",
    level: "⚫⚫",
    image: <Image src={css} alt="css" width="64" height="64" />,
  },
  {
    id: nanoid(),
    text: "JavaScript",
    level: "⚫⚫",
    image: <Image src={javascript} alt="js" width="64" height="64" />,
  },
  {
    id: nanoid(),
    text: "React",
    level: "⚫⚫⚫",
    image: <Image src={react} alt="react" width="64" height="64" />,
  },
  {
    id: nanoid(),
    text: "Next js",
    level: "⚫⚫",
    image: <Image src={next} alt="next js" width="64" height="64" />,
  },
  {
    id: nanoid(),
    text: "Tailwind CSS",
    level: "⚫⚫",
    image: <Image src={tailwind} alt="tailwind" width="64" height="64" />,
  },
  {
    id: nanoid(),
    text: "Redux",
    level: "⚫",
    image: <Image src={redux} alt="redux" width="64" height="64" />,
  },
  {
    id: nanoid(),
    text: "GitHub",
    level: "⚫⚫",
    image: <Image src={github} alt="github" width="64" height="64" />,
  },
  {
    id: nanoid(),
    text: "git",
    level: "⚫⚫",
    image: <Image src={git} alt="git" width="64" height="64" />,
  },
  // {
  //   id: nanoid(),
  //   text: "Node js",
